...
* My data collection looks like this ![Screenshot]( Data-Query/disc-2.png ) 

* I ran the following query which provided me the result of method_of_leak : inside job ![Screenshot]( Data-Query/disc-3.png ) 
